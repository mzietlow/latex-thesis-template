...
\documentclass[
  11pt, % Font size
  a4paper, % format
  numbers=noenddot, % 1.2 in TOC instead of 1.2.
  headsepline, % line between header and content
  listof=totoc,bibliography=totoc, % show list of figures/tables/etc in TOC
  % appendixprefix, % Show structure information (i.e. Appendix A) above chapters
  % openany, % Don't require chapters to start with an odd page number
  ]{scrbook}
